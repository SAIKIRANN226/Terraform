...
#   name        = var.sg_name                      # this name is for aws so what ever you write here resources will be created with this name only
#   description = var.description_name
  

#   ingress {
#     description      = "allow all traffic"
#     from_port        = var.inbound_name   # 0 means allow all 
#     to_port          = 0
#     protocol         = "tcp"
#     cidr_blocks      = var.cidr_name   # []-->indicates list, list must be in double quotes, internet for cidr is 0.0.0.0/0
